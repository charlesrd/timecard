...
$in_erid = (isset($_POST['erid'])) ? str_replace(' ', '', $_POST["erid"]) : "";
...
$sql = "SELECT ER.*, E.first_name, E.last_name FROM Employee_Review ER, Employee E WHERE ER.id = $in_erid AND ER.eid = E.id";
