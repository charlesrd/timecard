    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title" id="request-vacation-time-modal-title"><strong>Choose a week:</strong></h2>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <div id="request-vacation-time-row" class="row">
                        <div class="col-xs-12">
                            <div class="alert alert-info hide" role="alert">Only 1 Vacation Week is allowed per year.</div>
                            <div class="alert alert-success" role="alert"><strong>Vacation Weeks Remaining in <span class="selected-year"></span>: &nbsp; <span id="vacation-weeks-remaining"></span></strong></div>
...
<script type="text/javascript">
    ...
    findVacationWeeksRemaining(CURRENT_YEAR);
    ...
    $('#request-vacation-time-datepicker').datepicker( {
        ...
        onSelect: function(dateText, inst) { 
            ...
            // find the vacation weeks remaining for this user for the selected year
            findVacationWeeksRemaining(selectedYear);
            ...
            {
                errors += '<div class="alert alert-danger"><strong>Please Select a Week at least '+daysAhead+' days in the future.</strong></div>';
            }
